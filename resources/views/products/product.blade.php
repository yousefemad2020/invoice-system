...
@section('title', trans('settings_translate.products'))
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('settings_translate.settings') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('settings_translate.products') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0 w-25">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal"
                        href="#modaldemo8">{{ trans('settings_translate.add_product') }}</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap" id="example1" >
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">{{ trans('settings_translate.product_name') }}</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">{{ trans('settings_translate.add_product') }}</h6><button
                    ...
                    <form action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">{{ trans('settings_translate.product_name') }}</label>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ trans('settings_translate.product_edit') }}</h5>
                    ...
                    <form action="{{ route('products.update') }}" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <label for="recipient-name"
                                class="col-form-label">{{ trans('settings_translate.product_name') }}</label>
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('products.destroy') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="id" id="id" value="">
                        <input class="form-control" name="product_name" value="" id="product_name" readonly>
